                    ...
                    <div class="d-flex flex-warp">
                        @foreach ($tags as $tag)
                            <div class="d-flex align-items-center mt-3 me-3">
                                ...
                                <button type="button" class="btn-close ms-1" aria-model="削除" data-bs-toggle="modal" data-bs-target="#deleteTagModal" data-bs-dismiss="modal" data-tag-id="{{ $tag->id }}" data-tag-name="{{ $tag->name }}"></button>
                            </div>
                        @endforeach
                    </div>
                </div>
